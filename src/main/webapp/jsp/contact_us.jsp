...
<input type="tel" placeholder=" ENTER YOUR Phone Number" name="userPhone" required="required"class="form-control">
</div>

<div class="mb-4">

<label for="question" class="form-label">Ask Question</label>
<input type="text" placeholder=" ENTER YOUR Phone Number" name="userQuestion" required="required"class="form-control">
</div>
